...
# P300
points(df[c(6,5)],pch=pointtype,col="orange")
lines(df[c(6,5)],lwd=linewidth,col="orange")

# H3K27ac
points(df[c(6,2)],pch=pointtype,col="blue")
lines(df[c(6,2)],lwd=linewidth,col="blue")

# H3K4me1
points(df[c(6,3)],pch=pointtype,col="cyan")
lines(df[c(6,3)],lwd=linewidth,col="cyan")

# H3K4me2
points(df[c(6,4)],pch=pointtype,col="navy")
lines(df[c(6,4)],lwd=linewidth,col="navy")
